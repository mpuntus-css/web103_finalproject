...
What went well is that we were able to have a structure when it comes to effectively completing this in a reasonable amount of time.

### 2. What were some challenges your group faced in this unit?

Some challenges were figuring out how to set up the project board and directories for development.

### Did you finish all of your tasks in your sprint plan for this week? If you did not finish all of the planned tasks, how would you prioritize the remaining tasks on your list?

We didn't finish the planned tasks but we would need to prioritize getting onto development of the pages of our site while updating our statuses on the project board when we finish a feature.

### Which features and user stories would you consider “at risk”? How will you change your plan if those items remain “at risk”?

We are not sure yet whether our features and user stories are at risk.

### 5. What additional support will you need in upcoming units as you continue to work on your final project?

Not that we need immediately.
